...
def main() -> None:
    ...
    hf_dataset_path = "/Volumes/JAC_Backup/OpenFF/Meta-OMol25/huggingface_datasets/spice/spice_metadata"
    ase_db_path = "/Volumes/JAC_Backup/OpenFF/Meta-OMol25/ase_databases/spice.db"
